...
for idx, row in NorthCarol.iterrows():
    ...
    if(p =='Total' or p=='PROVISIONAL' or p=='ABSENTEE' or p=='CURBSIDE' or p=='ABSENTEE BY MAIL'
            or p =='OS LOB' or p =='ONE STOP' or p =='RINGW' or 'OS' in p or 'ABSENTEE' in p or p == 'TRANSFER'):
        continue
